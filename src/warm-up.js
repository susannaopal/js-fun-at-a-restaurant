...
var vegetables = ['cauliflower', 'carrots', 'mushrooms', 'cabbage', 'corn'];
...
var fruits = ['mango', 'kiwi', 'grapefruit', 'apple', 'grapes', 'cherries', 'bananas'];
...
groceryStore.location = 'Falls Church, VA'
